...
class Database:
    ...
    def get_statistics(self, period: str = 'day') -> Dict:
        ...
        download_speeds = [m['download_speed'] for m in measurements if m['download_speed']]
        upload_speeds = [m['upload_speed'] for m in measurements if m.get('upload_speed')]
    ...
    def export_to_csv(self, filename: str, start_date: Optional[str] = None, end_date: Optional[str] = None):
        ...
        with open(filename, 'w', newline='') as csvfile:
            ...
            for measurement in measurements:
                writer.writerow({field: measurement.get(field, '') for field in fieldnames})
